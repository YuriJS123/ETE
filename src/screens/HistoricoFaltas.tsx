  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitulo}>3° Info Manhã - {totalAlunos} alunos</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 24, fontWeight: '700', color: '#fff', marginBottom: 4 },
  subtitulo: { fontSize: 14, color: '#e0e7ff' },
